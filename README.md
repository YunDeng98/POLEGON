...
|**-burn_in**|optional|the number of MCMC burn-in iterations discarded before sampling. Default: 100|
...
|**-no_posterior_mean**|optional|if set, skip computing the posterior mean tree sequence.|
